...
`stop,prevent,self,`   +
  ...
  */
  ...
  function createRenderer(options) {
      ...
      function unmount(vnode, parentComponent, parentSuspense, doRemove) {
          ...
          if (doRemove) {
              ...
              if (vnode.shapeFlag & 1 /* ELEMENT */ && transition != null) {
  ...
  const Transition = createComponent({
      ...
      setup(props, { slots }) {
          ...
          return () => {
              ...
              const transitionData = (child.transition = resolveTransitionData(instance, rawProps, isMounted, performDelayedLeave));
  ...
  function resolveTransitionData(instance, { appear, onBeforeEnter, onEnter, onAfterEnter, onEnterCancelled, onBeforeLeave, onLeave, onAfterLeave, onLeaveCancelled }, isMounted, performDelayedLeave) {
      ...
      return {
          beforeEnter(el) {
              ...
              onBeforeEnter &&
                  callWithAsyncErrorHandling(onBeforeEnter, instance, 8 /* TRANSITION_HOOK */, [el]);
          },
          enter(el) {
              if (!isMounted && !appear) {
                  return;
              ...
              const done = () => {
                  onAfterEnter &&
                      callWithAsyncErrorHandling(onAfterEnter, instance, 8 /* TRANSITION_HOOK */, [el]);
                  performDelayedLeave();
              };
              if (onEnter) {
                  onEnter(el, done);
          ...
          leave(el, remove) {
              onBeforeLeave &&
                  callWithAsyncErrorHandling(onBeforeLeave, instance, 8 /* TRANSITION_HOOK */, [el]);
              const afterLeave = () => onAfterLeave &&
                  callWithAsyncErrorHandling(onAfterLeave, instance, 8 /* TRANSITION_HOOK */, [el]);
              if (onLeave) {
                  onLeave(el, () => {
                      remove();
                      afterLeave();
  ...
  function updateHOCTransitionData(vnode, data) {
      if (vnode.shapeFlag & 6 /* COMPONENT */) {
